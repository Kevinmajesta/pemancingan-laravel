                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div style="text-align: center">
                            <img src="{{ asset('assets/images/dashboard/rb_2151199745.png') }}" class="img-fluid w-50"
                                alt="R&Y Fishing">
                        </div>
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1 d-flex align-items-center">
                                            <div class="border-right w-75" style="height: 100%; border-right-width: 10px;">
                                            </div>
                                        </div>
                                ...
                                <div class="carousel-item">
                                    <div class="row">
                                        ...
                                        <!-- Garis Pembatas -->
                                        <div class="col-md-1 d-flex align-items-center">
                                            <div class="border-right w-75" style="height: 100%; border-right-width: 4px;">
                                            </div>
                                        </div>
