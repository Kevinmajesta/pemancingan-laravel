    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="scheduleMenu">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                        <span class="nav-link" style="cursor: pointer;" onclick="window.location='/schedule/user'">
                            Schedule
                        </span>
                    </li>
                </ul>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="kritikMenu">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                        <span class="nav-link" style="cursor: pointer;" onclick="window.location='/kritik/user'">
                            Kritik dan Saran
                        </span>
                    </li>
                </ul>
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#pemenangMenu" aria-controls="pemenangMenu">
                ...
                <span class="menu-title">Pelanggan Terbaik</span>
                <i class="menu-arrow"></i>
            </a>
